...
class CIO4WC_Gateway extends WC_Payment_Gateway_CC {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'test_secret_key'   => array(
                'type'          => 'text',
                'title'         => __( 'Test Secret key', 'chargeio-for-woocommerce' ),
                'default'       => '',
            ),
            'test_publishable_key' => array(
                'type'          => 'text',
                'title'         => __( 'Test Public key', 'chargeio-for-woocommerce' ),
                'default'       => '',
            ),
            'test_account'  => array(
                'type'      => 'text',
                'title'     => __( 'Test Account ID', 'chargeio-for-woocommerce' ),
                'default'   => '',
            ),
            'live_secret_key'   => array(
                'type'          => 'text',
                'title'         => __( 'Live Secret key', 'chargeio-for-woocommerce' ),
                'default'       => '',
            ),
            'live_publishable_key' => array(
                'type'          => 'text',
                'title'         => __( 'Live Public key', 'chargeio-for-woocommerce' ),
                'default'       => '',
            ),
            'live_account'  => array(
                'type'      => 'text',
                'title'     => __( 'Live Account ID', 'chargeio-for-woocommerce' ),
                'default'   => '',
            ),
        );
    }
    ...
    public function admin_options() {
        ...
        <table class="form-table">
            ...
            <tr>
                <th><?php _e( 'Delete Test Data', 'chargeio-for-woocommerce' ); ?></th>
                <td>
                    <p>
